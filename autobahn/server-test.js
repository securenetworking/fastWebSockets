...
const server = $`fastWebSockets/EchoServer`.spawn();
...
const result = Object.values(JSON.parse(Deno.readTextFileSync("./fastWebSockets/autobahn/reports/servers/index.json"))["fastWebSockets"]);
